            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <form class="row g-3" method="get" action="${root}/tripPlan/list">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="button" class="btn btn-primary mb-3" onclick="location.href='${root}/tripPlan/create'">글쓰기</button>
                    </div>
                </form>
            </div>
                ...
                <table class="table m-auto wrapper">
                    ...
                    <c:forEach items="${plans}" var="plan" varStatus="status">
                        <tr>
                            ...
                            <td><a class='linkToNotion' href='${root}/tripPlan/detail/${plan.tripPlanId}'>${plan.title}</a></td>

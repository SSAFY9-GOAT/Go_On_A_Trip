...
<main class="container">
  ...
  <div class="row">
    ...
    <form class="col col-6" action="${root}/hotPlace?action=edit" method="post" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="name" name="name" value="${hotPlace.name}">
      </div>
      <div class="mb-3">
